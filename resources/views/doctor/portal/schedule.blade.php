...
@section('content')
    ...
    _________________________________________________________ -->
            ...
            <div class="col-sm-10 main-content">
                <div class="row">
                    <div class="col-md-4">
                        <p class="body-heading"><strong>Schedule Management</strong> - <span>Doctor</span></p>
                    </div>

                    <div class="col-md-2">
                        <a href="{{ URL::to('/') }}/doctor/schedule/add" class="table-link">ADD SCHEDULE</a>
                    </div>
                                ...
                                <div class="table-responsive">
                                    <table class="table user-list">
                                        ...
                                        <tr>
                                            ...
                                            <th><span>Hospital</span></th>
                                            <th><span>Schedule details</span></th>
                                        ...
                                        @foreach($hospitalInfo as $hospitalInfoValue)
                                            <tr>
                                                ...
                                                <td>
                                                    Date: {{$hospitalInfoValue->schedule_date}} <br/>
                                                    Time: {{$hospitalInfoValue->schedule_from_time}} -  {{$hospitalInfoValue->schedule_to_time}}
                                                </td>
