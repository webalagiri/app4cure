...
<!-- Css animations  -->
{!!  Html::style(asset('admi/css/animate.css')) !!}

<!-- Theme stylesheet, if possible do not edit this stylesheet -->
{!!  Html::style(asset('admi/css/style.default.css')) !!}

<!-- Custom stylesheet - for your changes -->
{!!  Html::style(asset('admi/css/custom.css')) !!}
...
{!!  Html::style(asset('admi/css/owl.carousel.css')) !!}
{!!  Html::style(asset('admi/css/owl.theme.css')) !!}


{!! Html::style(asset('admi/css/reset.css')) !!}
