    ...
    _________________________________________________________ -->
            ...
            <div class="col-sm-10 main-content">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="box">
                            <h2 class="text-uppercase">New Hospital</h2>
                            ...
                            {!! Form::open( array( 'route' => array('hospital.save') ,'role' => 'form' ,'method'=>'POST', 'files'=>true,'class'=>'') ) !!}
                            ...
                            <div class="form-group">
                                <label for="detail-login">Hospital Details</label>
                                <input type="text" class="form-control" id="name-login" name="hospital_details" value="{{Input::old('hospital_details')}}" required="required" />
                                @if ($errors->has('hospital_details'))<p class="error" style="">{!!$errors->first('hospital_details')!!}</p>@endif
                            </div>

                            <div class="form-group">
                                <label for="name-login">Contact Name</label>
                                <input type="text" class="form-control" id="name-login" name="hospital_contact_name" value="{{Input::old('hospital_contact_name')}}" required="required" />
                                @if ($errors->has('hospital_contact_name'))<p class="error" style="">{!!$errors->first('hospital_contact_name')!!}</p>@endif
                            </div>

                            <div class="form-group">
                                <label for="address-login">Contact Telephone</label>
                                <input type="text" class="form-control" id="email-login" name="hospital_contact_mobile" value="{{Input::old('hospital_contact_mobile')}}" required="required" />
                                @if ($errors->has('hospital_contact_mobile'))<p class="error" style="">{!!$errors->first('hospital_contact_mobile')!!}</p>@endif
                            </div>
