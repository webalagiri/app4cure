<section class="sidebar">
    ...
    <div class="user-panel">
        <div class="pull-left image">
            <img src="{{ URL::to('/') }}/images/lab-160x160.jpg" class="img-circle" alt="User Image" />
        </div>
    ...
    <ul class="sidebar-menu">
        ...
        <li class="@if($profile_menu==1) active @endif treeview">
            ...
            <ul class="treeview-menu">
                <li><a href="{{URL::to('/')}}/lab/rest/api/{{Auth::user()->id}}/profile"><i class="fa fa-circle-o"></i> View Profile</a></li>
                <li><a href="{{URL::to('/')}}/lab/rest/api/{{Auth::user()->id}}/editprofile"><i class="fa fa-circle-o"></i> Edit Profile</a></li>
                <!--
                 <li><a href="{{URL::to('/')}}/lab/rest/api/{{Auth::user()->id}}/changepassword"><i class="fa fa-circle-o"></i> Change Password</a></li>
                 -->
            </ul>
        </li>
